...
def getProductList(start_time, end_time, product = 'ABI-L1b-RadC', satellite = 16):
    ...
    ## Get all the dates between the query time
    ...
    #!TODO: Add a check, to handel if no file is returned.
...
def download(df, BASEDIR, startTime = None, makeGeoTiff = False, tz = "US/Pacific", verbose = True):
