...
def trackLatency(dataProductCode, check_ever_n_seconds = 1, download = True, verbose = False, extraVerbose = False):
    ...
    while True:
        df = helper.getProductList(start_time, end_time, product = radProduct, satellite = 16, verbose = extraVerbose)
...
for i in range(240):
    ...
    df.to_csv("./.tmp/latency" + str(i) + ".csv")
